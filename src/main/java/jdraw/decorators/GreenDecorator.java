...
public class GreenDecorator implements Figure {
    ...
    // zum lösche entweder es ish grad das, oder wiiter d ketti entlang luege
    @Override
    ...
    private static class GraphicDecorator extends Graphics{
        private final Graphics inner;

         GraphicDecorator(Graphics inner) {
            this.inner = inner;
        }
